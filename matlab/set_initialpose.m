...
msg = rosmessage(Initialize);
    ...
    msg.Pose.Pose.Orientation.X = yaw_quat(:,2);
    msg.Pose.Pose.Orientation.Y = yaw_quat(:,3);
    msg.Pose.Pose.Orientation.Z =yaw_quat(:,4);
    msg.Pose.Pose.Orientation.W = yaw_quat(:,1);
